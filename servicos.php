...
<section class="bloco artigo">
	<article>
		...
		<p>O comércio de defensivos agrícolas deu origem às nossas atividades. Com atuação diferenciada em toda a região do médio-norte de Mato Grosso, hoje também fornecemos biodiesel, fertilizantes, sementes e assistência técnica especializada para os cultivos de soja, milho, algodão, sorgo, feijão e arroz.</p>
	</article>

	<article class="alinhamento-direita">
		<figure>
			<img src="imagens/icon1_servicos.png" alt="">
			<caption>Originação</caption>
		</figure>
		<p>Estamos consolidados no mercado brasileiro de originação de soja e milho com uma prestação de serviço de qualidade para armazenamento de grãos.</p>

		<p>Cientes da importância da qualidade dos grãos para todos os envolvidos em nossos negócios, desde 1997 investimos continuamente no aprimoramento de nossas unidades armazenadoras de grãos e no processo de comercialização.</p>
	...
	<article class="alinhamento-direita">
		<figure>
			<img src="imagens/icon2_servicos.png" alt="">
			<caption>INSUMOS</caption>
		</figure>
		<p>Estamos estabelecidos no mercado também como fornecedores de fertilizantes, sementes e defensivos agrícolas para os cultivos de soja, milho, algodão, sorgo, feijão, girassol e arroz, sempre com a atenção focada na qualidade e na segurança dos produtos.</p>

		<p>Atuamos em uma área com 3 milhões de hectares no Mato Grosso e 350 mil hectares no Tocantins na cultura de soja. Em segunda safra, 50% destas áreas são voltadas para a cultura de milho.</p>

		<p>Fazendo uso dos melhores produtos e tecnologias disponíveis no mercado e com sistemático monitoramento da produção, oferecemos assistência técnica especializada e estruturada nos principais centros agrícolas, com recomendações técnicas no local com o objetivo de obter segurança durante todo o ciclo de produção.</p>
		
		<p>Além disso, desempenhamos uma função estratégica de apoio e compromisso com nossos clientes, que contam com a nossa pontualidade na entrega dos produtos e condicionamento adequado de ponta a ponta.</p>
	</article>

	<article class="alinhamento-direita">
		<figure>
			<img src="imagens/icon3_servicos.png" alt="">
			<caption>BIODIESEL</caption>
		</figure>
...
<section class="bloco artigo">
	<article>
		<header>
			<h3>Participação da Fiagril em Associações e Organizações Setoriais Nacionais</h3>
		</header>
		<p class='lista-seta'>Associação Brasileira das Indústrias de Óleos Vegetais (ABIOVE)</p>
		<p class='lista-seta'>União Brasileira do Biodiesel e Bioquerosene (UBRABIO)</p>
		<p class='lista-seta'>Sindicato das Indústrias do Biodiesel no Estado de Mato Grosso (SindiBio-MT)(ABIOVE)</p>
		<p class='lista-seta'>Câmara Setorial de Oleaginosas e Biodiesel Associação Nacional dos Exportadores de Cereais (ANEC)</p>
		<p class='lista-seta'>Conselho Estadual das Associações das Revendas de Produtos Agropecuários do Estado de Mato Grosso (CEARPA)</p>
		<p class='lista-seta'>Associação Nacional dos Distribuidores de Insumos Agrícolas e Veterinários (ANDAV)</p>
		<p class='lista-seta'>Associação Nacional de Defesa Vegetal (ANDEF)</p>
	</article>
